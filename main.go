...
import (
	...
	"github.com/arutselvan15/external-dns/controller"
	"github.com/arutselvan15/external-dns/endpoint"
	"github.com/arutselvan15/external-dns/pkg/apis/externaldns"
	"github.com/arutselvan15/external-dns/pkg/apis/externaldns/validation"
	"github.com/arutselvan15/external-dns/plan"
	"github.com/arutselvan15/external-dns/provider"
	"github.com/arutselvan15/external-dns/provider/akamai"
	"github.com/arutselvan15/external-dns/provider/alibabacloud"
	"github.com/arutselvan15/external-dns/provider/aws"
	"github.com/arutselvan15/external-dns/provider/awssd"
	"github.com/arutselvan15/external-dns/provider/azure"
	"github.com/arutselvan15/external-dns/provider/bluecat"
	"github.com/arutselvan15/external-dns/provider/cloudflare"
	"github.com/arutselvan15/external-dns/provider/coredns"
	"github.com/arutselvan15/external-dns/provider/designate"
	"github.com/arutselvan15/external-dns/provider/digitalocean"
	"github.com/arutselvan15/external-dns/provider/dnsimple"
	"github.com/arutselvan15/external-dns/provider/dyn"
	"github.com/arutselvan15/external-dns/provider/exoscale"
	"github.com/arutselvan15/external-dns/provider/gandi"
	"github.com/arutselvan15/external-dns/provider/godaddy"
	"github.com/arutselvan15/external-dns/provider/google"
	"github.com/arutselvan15/external-dns/provider/ibmcloud"
	"github.com/arutselvan15/external-dns/provider/infoblox"
	"github.com/arutselvan15/external-dns/provider/inmemory"
	"github.com/arutselvan15/external-dns/provider/linode"
	"github.com/arutselvan15/external-dns/provider/ns1"
	"github.com/arutselvan15/external-dns/provider/oci"
	"github.com/arutselvan15/external-dns/provider/ovh"
	"github.com/arutselvan15/external-dns/provider/pdns"
	"github.com/arutselvan15/external-dns/provider/rcode0"
	"github.com/arutselvan15/external-dns/provider/rdns"
	"github.com/arutselvan15/external-dns/provider/rfc2136"
	"github.com/arutselvan15/external-dns/provider/safedns"
	"github.com/arutselvan15/external-dns/provider/scaleway"
	"github.com/arutselvan15/external-dns/provider/transip"
	"github.com/arutselvan15/external-dns/provider/ultradns"
	"github.com/arutselvan15/external-dns/provider/vinyldns"
	"github.com/arutselvan15/external-dns/provider/vultr"
	"github.com/arutselvan15/external-dns/registry"
